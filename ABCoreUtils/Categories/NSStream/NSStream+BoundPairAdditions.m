...
+ (void)createBoundInputStream:(NSInputStream * __autoreleasing *)inputStreamPtr outputStream:(NSOutputStream * __autoreleasing *)outputStreamPtr bufferSize:(NSUInteger)bufferSize
{
    CFReadStreamRef     readStream;
    CFWriteStreamRef    writeStream;
